	...
	["app"], {
		...
		"7Qib": function(e, t, n) {
			...
			function a(e, t) {
				...
				var n = t || "{y}-{m}-{d} {h}:{i}:{s}",
					i = void 0;
				"object" === (void 0 === e ? "undefined" : o()(e)) ? i = e: (10 === ("" + e).length && (e = 1e3 * parseInt(e)),
					i = new Date(e));
				var a = {
					y: i.getFullYear(),
					m: i.getMonth() + 1,
			...
			function r(e, t) {
				...
				var n = new Date(e),
					i = (Date.now() - n) / 1e3;
				return i < 30 ? "刚刚" : i < 3600 ? Math.ceil(i / 60) + "分钟前" : i < 86400 ? Math.ceil(i / 3600) + "小时前" : i <
					172800 ? "1天前" : t ? a(e, t) : n.getMonth() + 1 + "月" + n.getDate() + "日" + n.getHours() + "时" + n.getMinutes() +
					"分"
			}
			...
			function c(e, t, n) {
				var i = void 0,
					...
					c = function c() {
						var l = +new Date - r;
						l < t && l > 0 ? i = setTimeout(c, t - l) : (i = null, n || (s = e.apply(a, o), i || (a = o = null)))
					};
				return function() {
					for (var o = arguments.length, l = Array(o), u = 0; u < o; u++) l[u] = arguments[u];
					a = this, r = +new Date;
					var d = n && !i;
					return i || (i = setTimeout(c, t)), d && (s = e.apply(a, l), a = l = null), s
				}
			}
			...
			var i = {
					...
					methods: {
						handleSetLanguage: function(e) {
							this.$i18n.locale = e, this.$store.dispatch("setLanguage", e), this.$message({
				...
				a = Object(o.a)(i, function() {
					...
					}, [e._v("中文")]), e._v(" "), n("el-dropdown-item", {
						attrs: {
							disabled: "en" === e.language,
							command: "en"
						}
					}, [e._v("English")]), e._v(" "), n("el-dropdown-item", {
						attrs: {
							disabled: "es" === e.language,
							command: "es"
						}
					}, [e._v("Español")])], 1)], 1)
				}, [], !1, null, "753af672", null);
			a.options.__file = "index.vue";
			t.a = a.exports
		},
		EqXK: function(e, t, n) {
			"use strict";
			...
			var i = n("Mpsw"),
				...
				s = {
					state: {
						...
						device: "desktop",
						language: r.a.get("language") || "en",
						size: r.a.get("size") || "medium"
					},
					mutations: {
						TOGGLE_SIDEBAR: function(e) {
							e.sidebar.opened ? r.a.set("sidebarStatus", 1) : r.a.set("sidebarStatus", 0), e.sidebar.opened = !e.sidebar.opened,
						...
						SET_LANGUAGE: function(e, t) {
							e.language = t, r.a.set("language", t)
						},
			...
			var m = {
					...
					mutations: {
						SET_ROUTERS: function(e, t) {
							e.addRouters = t, e.routers = p.b.concat(t)
						}
					},
					actions: {
						GenerateRoutes: function(e, t) {
							...
							return new u.a(function(e) {
								var i = t.roles,
									o = void 0;
								o = i.includes("admin") ? p.a : function e(t, n) {
									var i = [];
									return t.forEach(function(t) {
										...
										})(n, o) && (o.children && (o.children = e(o.children, n)), i.push(o))
									}), i
								}(p.a, i), n("SET_ROUTERS", o), e()
							})
						}
					}
				},
					...
					mutations: {
						...
						DEL_VISITED_VIEW: function(e, t) {
							var n = !0,
								...
								o = void 0;
							try {
								for (var a, r = w()(e.visitedViews.entries()); !(n = (a = r.next()).done); n = !0) {
									var s = a.value,
										c = T()(s, 2),
										l = c[0];
									if (c[1].path === t.path) {
						...
						DEL_CACHED_VIEW: function(e, t) {
							var n = !0,
								...
								o = void 0;
							try {
								for (var a, r = w()(e.cachedViews); !(n = (a = r.next()).done); n = !0) {
									var s = a.value;
									if (s === t.name) {
										var c = e.cachedViews.indexOf(s);
						...
						UPDATE_VISITED_VIEW: function(e, t) {
							var n = !0,
								...
								o = void 0;
							try {
								for (var a, r = w()(e.visitedViews); !(n = (a = r.next()).done); n = !0) {
									var s = a.value;
									if (s.path === t.path) {
										s = y()(s, t);
										break
					...
					actions: {
						...
						delView: function(e, t) {
							...
							return new u.a(function(e) {
								n("delVisitedView", t), n("delCachedView", t), e({
									visitedViews: [].concat(v()(i.visitedViews)),
									cachedViews: [].concat(v()(i.cachedViews))
								})
							})
						},
						delVisitedView: function(e, t) {
							var n = e.commit,
								i = e.state;
							return new u.a(function(e) {
								n("DEL_VISITED_VIEW", t), e([].concat(v()(i.visitedViews)))
							})
						},
						delCachedView: function(e, t) {
							var n = e.commit,
								i = e.state;
							return new u.a(function(e) {
								n("DEL_CACHED_VIEW", t), e([].concat(v()(i.cachedViews)))
							})
						},
						...
						delOthersVisitedViews: function(e, t) {
							var n = e.commit,
								i = e.state;
							return new u.a(function(e) {
								n("DEL_OTHERS_VISITED_VIEWS", t), e([].concat(v()(i.visitedViews)))
							})
						},
						delOthersCachedViews: function(e, t) {
							var n = e.commit,
								i = e.state;
							return new u.a(function(e) {
								n("DEL_OTHERS_CACHED_VIEWS", t), e([].concat(v()(i.cachedViews)))
							})
						},
						...
						delAllVisitedViews: function(e) {
							var t = e.commit,
								n = e.state;
							return new u.a(function(e) {
								t("DEL_ALL_VISITED_VIEWS"), e([].concat(v()(n.visitedViews)))
							})
						},
						delAllCachedViews: function(e) {
							var t = e.commit,
								n = e.state;
							return new u.a(function(e) {
								t("DEL_ALL_CACHED_VIEWS"), e([].concat(v()(n.cachedViews)))
							})
						},
					...
					actions: {
						LoginByUsername: function(e, t) {
							...
							return new u.a(function(e, o) {
								Object(_.d)(i, t.password).then(function(t) {
									if ("passed" === t.data.status) {
										var i = t.data.duty;
										n("SET_TOKEN", i.token), Object(C.c)(i.token), e(t)
									} else n("SET_TOKEN", ""), n("SET_ROLES", []), Object(C.b)(), e(t)
								}).catch(function(e) {
									o(e)
								})
							})
						...
						GetUserInfo: function(e) {
							...
							return new u.a(function(e, i) {
								Object(_.b)(n.token).then(function(n) {
									n.data || i("error");
									var o = n.data.duty;
									o.roles && o.roles.length > 0 ? t("SET_ROLES", o.roles) : i(
											"getInfo: roles must be a non-null array !"), t("SET_NAME", o.name), t("SET_INTRODUCTION", o.introduction),
										e(n)
								}).catch(function(e) {
									i(e)
								})
						...
						ChangeRoles: function(e, t) {
							var n = e.commit,
								i = e.dispatch;
							return new u.a(function(e) {
								n("SET_TOKEN", t), Object(C.c)(t), Object(_.b)(t).then(function(t) {
									var o = t.data;
									n("SET_ROLES", o.roles), n("SET_NAME", o.name), n("SET_INTRODUCTION", o.introduction), i(
										"GenerateRoutes", o), e()
								})
							})
						}
				...
				S = {
					...
					mutations: {
						SET_TEMPTABLE: function(e, t) {
							e.tempTable = t
						},
						SET_ORIGTABLE: function(e, t) {
							e.origTable = t
						},
						SET_PROJECT: function(e, t) {
							e.project = t
						},
						SET_TEMPCASES: function(e, t) {
							e.tempTestCases = t
						},
						SET_ORIGCASES: function(e, t) {
							e.origTestCases = t
						},
						SET_TEMPSUITE: function(e, t) {
							e.tempTestSuite = t
						},
						SET_ORIGSUITE: function(e, t) {
							e.origTestSuite = t
						},
						SET_TEMPDATA: function(e, t) {
							e.tempTestData = t
						},
						SET_ORIGDATA: function(e, t) {
							e.origTestData = t
						},
						SET_TEMPOBJECT: function(e, t) {
							e.tempTestObject = t
						},
						SET_ORIGOBJECT: function(e, t) {
							e.origTestObject = t
						},
						SET_TEMPREPORT: function(e, t) {
							e.tempTestReport = t
						},
						SET_ORIGREPORT: function(e, t) {
							e.origTestReport = t
						},
						SET_TEMPMODULE: function(e, t) {
							e.tempTestModule = t
						},
						SET_ORIGMODULE: function(e, t) {
							e.origTestModule = t
						}
					},
					actions: {
						setTempTable: function(e, t) {
							(0, e.commit)("SET_TEMPTABLE", t)
						},
						setOrigTable: function(e, t) {
							(0, e.commit)("SET_ORIGTABLE", t)
						},
						setProject: function(e, t) {
							(0, e.commit)("SET_PROJECT", t)
						},
						setTempCases: function(e, t) {
							(0, e.commit)("SET_TEMPCASES", t)
						},
						setOrigCases: function(e, t) {
							(0, e.commit)("SET_ORIGCASES", t)
						},
						setTempSuite: function(e, t) {
							(0, e.commit)("SET_TEMPSUITE", t)
						},
						setOrigSuite: function(e, t) {
							(0, e.commit)("SET_ORIGSUITE", t)
						},
						setTempData: function(e, t) {
							(0, e.commit)("SET_TEMPDATA", t)
						},
						setOrigData: function(e, t) {
							(0, e.commit)("SET_ORIGDATA", t)
						},
						setTempObject: function(e, t) {
							(0, e.commit)("SET_TEMPOBJECT", t)
						},
						setOrigObject: function(e, t) {
							(0, e.commit)("SET_ORIGOBJECT", t)
						},
						setTempReport: function(e, t) {
							(0, e.commit)("SET_TEMPREPORT", t)
						},
						setOrigReport: function(e, t) {
							(0, e.commit)("SET_ORIGREPORT", t)
						},
						setTempModule: function(e, t) {
							(0, e.commit)("SET_TEMPMODULE", t)
						},
						setOrigModule: function(e, t) {
							(0, e.commit)("SET_ORIGMODULE", t)
						}
					}
				},
				k = {
					...
					tempDataTable: function(e) {
						return e.data.tempTable
					},
					origDataTable: function(e) {
						return e.data.origTable
					},
					projectName: function(e) {
						return e.data.project
					},
					tempTestCases: function(e) {
						return e.data.tempTestCases
					},
					origTestCases: function(e) {
						return e.data.origTestCases
					},
					tempTestSuite: function(e) {
						return e.data.tempTestSuite
					},
					origTestSuite: function(e) {
						return e.data.origTestSuite
					},
					tempTestData: function(e) {
						return e.data.tempTestData
					},
					origTestData: function(e) {
						return e.data.origTestData
					},
					tempTestObject: function(e) {
						return e.data.tempTestObject
					},
					origTestObject: function(e) {
						return e.data.origTestObject
					},
					tempTestReport: function(e) {
						return e.data.tempTestReport
					},
					origTestReport: function(e) {
						return e.data.origTestReport
					},
					tempTestModule: function(e) {
						return e.data.tempTestModule
					},
					origTestModule: function(e) {
						return e.data.origTestModule
					}
				};
			i.default.use(o.a);
			var z = new o.a.Store({
		...
		"Uf/o": function(e, t, n) {
			...
			}, o.resolve = a, e.exports = o, o.id = "Uf/o"
		},
		"VtY+": function(e, t, n) {
			"use strict";
			n.r(t);
		...
		Vtdi: function(e, t, n) {
			...
			var V = {
				...
				z = (n("GbIm"), Object(h.a)(k, function() {
					var e = this.$createElement,
						t = this._self._c || e;
					return t("svg", {
						class: this.svgClass,
				...
				}, [], !1, null, "22425877", null));
			z.options.__file = "index.vue";
			var M = z.exports;
			r.default.component("svg-icon", M);
			! function(e) {
				e.keys().map(e)
			}(n("Uf/o")), r.default.config.errorHandler = function(e, t, n, i) {
				r.default.nextTick(function() {
					v.a.dispatch("addErrorLog", {
						err: e,
						vm: t,
						info: n,
			...
			var I = ["/login", "/auth-redirect"];
			f.c.beforeEach(function(e, t, n) {
				if (O.a.start(), e.meta.title) {
					var i = e.meta.title.slice(0, 1).toUpperCase() + e.meta.title.slice(1);
					document.title = i
				}
				Object(L.a)() ? "/login" === e.path ? (n({
					path: "/"
				}), O.a.done()) : 0 === v.a.getters.roles.length ? v.a.dispatch("GetUserInfo").then(function(t) {
					var i = t.data.duty.roles;
					v.a.dispatch("GenerateRoutes", {
						roles: i
					}).then(function() {
						f.c.addRoutes(v.a.getters.addRouters), n(w()({}, e, {
							replace: !0
						}))
					})
				}).catch(function(e) {
					v.a.dispatch("FedLogOut").then(function() {
						l.Message.error(e || "Verification failed, please login again"), n({
							path: "/"
						})
					})
				}) : ! function(e, t) {
				...
				}(v.a.getters.roles, e.meta.roles) ? n({
					path: "/401",
					replace: !0,
					query: {
						noGoBack: !0
					}
				}) : n() : -1 !== I.indexOf(e.path) ? n() : (n("/login?redirect=" + e.path), O.a.done())
			}), f.c.afterEach(function() {
				O.a.done()
			});
			for (var B = n("/dyU"), A = n.n(B), H = n("7Qib"), R = n("rerW"), P = n.n(R), j = [], $ = 0; $ < 100; $++) j.push(
				A.a.mock({
					id: "@increment",
					timestamp: +A.a.Random.date("T"),
					author: "@first",
					reviewer: "@first",
					title: "@title(5, 10)",
			...
			for (var U = function(e) {
					var t = Object(H.d)(e.url),
						...
						c = void 0 === s ? 20 : s,
						l = t.sort,
						u = j.filter(function(e) {
							return (!n || e.importance === +n) && ((!i || e.type === i) && !(o && e.title.indexOf(o) < 0))
						});
					"-id" === l && (u = u.reverse());
					var d = u.filter(function(e, t) {
						return t < c * r && t >= c * (r - 1)
					});
					return {
						total: u.length,
						items: d
					...
					var t = Object(H.d)(e.url).id,
						n = !0,
						i = !1,
						o = void 0;
					try {
						for (var a, r = P()(j); !(n = (a = r.next()).done); n = !0) {
							var s = a.value;
							if (s.id === +t) return s
						}
					} catch (e) {
			...
			for (var W = function(e) {
					var t = Object(H.d)(e.url).name;
					return {
						items: J.filter(function(e) {
							var n = e.name.toLowerCase();
							return !(t && n.indexOf(t.toLowerCase()) < 0)
						})
					}
				}, Y = [], Q = 0; Q < 20; Q++) Y.push(A.a.mock({
				order_no: "@guid()",
				timestamp: +A.a.Random.date("T"),
				username: "@name()",
			...
			A.a.XHR.prototype.proxy_send = A.a.XHR.prototype.send, A.a.XHR.prototype.send = function() {
				this.custom.xhr && (this.custom.xhr.withCredentials = this.withCredentials || !1), this.proxy_send.apply(this,
					arguments)
			}, A.a.mock(/\/article\/list/, "get", U), A.a.mock(/\/article\/detail/, "get", N), A.a.mock(/\/article\/pv/,
				"get", G), A.a.mock(/\/article\/create/, "post", q), A.a.mock(/\/article\/update/, "post", F), A.a.mock(
				/\/search\/user/, "get", W), A.a.mock(/\/transaction\/list/, "get", K);
			A.a;
			...
			function ee(e) {
				...
				return t < 3600 ? X(~~(t / 60), " minute") : t < 86400 ? X(~~(t / 3600), " hour") : X(~~(t / 86400), " day")
			}
		...
		oYx3: function(e, t, n) {
			...
			var l = n("wu4H"),
					...
					methods: {
						...
						getBreadcrumb: function() {
							var e = this.$route.matched.filter(function(e) {
								...
								t = e[0];
							t && t.name.trim().toLocaleLowerCase() !== "Dashboard".toLocaleLowerCase() && (e = [{
								path: "/dashboard",
								meta: {
									title: "dashboard"
								}
				...
				p = Object(h.a)(d, function() {
					...
					return n("el-breadcrumb", {
						...
						}, [e._v(e._s(e.generateTitle(t.meta.title)))]) : n("a", {
							on: {
								click: function(n) {
									n.preventDefault(), e.handleLink(t)
								}
							}
						}, [e._v(e._s(e.generateTitle(t.meta.title)))])]) : e._e()
					}))], 1)
				}, [], !1, null, "32e11dfe", null);
			...
			var m = p.exports,
				...
				v = (n("jyj9"), Object(h.a)(f, function() {
					var e = this.$createElement,
						t = this._self._c || e;
					return t("div", [t("svg", {
			...
			var g = v.exports,
				...
				b = (n("qnLb"), Object(h.a)(w, function() {
					var e = this,
						t = e.$createElement,
						n = e._self._c || t;
					return e.errorLogs.length > 0 ? n("div", [n("el-badge", {
						...
						scopedSlots: e._u([{
							...
							fn: function(t) {
								...
								}, [e._v(e._s(t.row.err.message))])], 1), e._v(" "), n("br"), e._v(" "), n("div", [n("span", {
									staticClass: "message-title",
									staticStyle: {
										"padding-right": "10px"
									}
								...
								}, [e._v(e._s(t.row.vm.$vnode.tag) + " error in " + e._s(t.row.info))])], 1), e._v(" "), n(
									"br"), e._v(" "), n("div", [n("span", {
									staticClass: "message-title",
									staticStyle: {
										"padding-right": "16px"
									}
			...
			var T = b.exports,
				...
				_ = (n("bFmj"), Object(h.a)(E, function() {
					var e = this.$createElement,
						t = this._self._c || e;
					return t("div", [t("svg", {
				...
				}, [], !1, null, "4109367e", null));
			_.options.__file = "index.vue";
			var C = _.exports,
				V = {
					computed: {
						size: function() {
					...
					methods: {
						handleSetSize: function(e) {
							this.$ELEMENT.size = e, this.$store.dispatch("setSize", e), this.refreshView(), this.$message({
				...
				S = (n("Dy8W"), Object(h.a)(V, function() {
					var e = this,
						t = e.$createElement,
						n = e._self._c || t;
					return n("el-dropdown", {
					...
					}, [e._v("Medium")]), e._v(" "), n("el-dropdown-item", {
						attrs: {
							disabled: "small" === e.size,
							command: "small"
						}
					}, [e._v("Small")]), e._v(" "), n("el-dropdown-item", {
						attrs: {
							disabled: "mini" === e.size,
							command: "mini"
						}
					}, [e._v("Mini")])], 1)], 1)
				}, [], !1, null, "b2a75600", null));
						...
						theme: function(e, t) {
							...
							if ("string" == typeof e) {
								var i = this.getThemeCluster(e.replace("#", "")),
									o = this.getThemeCluster(t.replace("#", ""));
								console.log(i, o);
								var a = function(e, t) {
									return function() {
										var o = n.getThemeCluster("#409EFF".replace("#", "")),
											a = n.updateStyle(n[e], o, i),
											r = document.getElementById(t);
										r || ((r = document.createElement("style")).setAttribute("id", t), document.head.appendChild(r)), r.innerText =
											a
									}
								}("chalk", "chalk-style");
								if (this.chalk) a();
								else {
									var r = "https://unpkg.com/element-ui@" + M + "/lib/theme-chalk/index.css";
									this.getCSSString(r, a, "chalk")
								} [].slice.call(document.querySelectorAll("style")).filter(function(e) {
									var n = e.innerText;
									return new RegExp(t, "i").test(n) && !/Chalk Variables/.test(n)
								}).forEach(function(e) {
									var t = e.innerText;
									"string" == typeof t && (e.innerText = n.updateStyle(t, o, i))
								}), this.$message({
									message: "换肤成功",
									type: "success"
								})
					...
					methods: {
						...
						getCSSString: function(e, t, n) {
							...
							o.onreadystatechange = function() {
								4 === o.readyState && 200 === o.status && (i[n] = o.responseText.replace(/@font-face{[^}]+}/, ""), t())
							}, o.open("GET", e), o.send()
						},
						getThemeCluster: function(e) {
							for (var t = function(e, t) {
									...
									return 0 === t ? [n, i, o].join(",") : (n += Math.round(t * (255 - n)), i += Math.round(t * (255 - i)), o +=
										Math.round(t * (255 - o)), "#" + (n = n.toString(16)) + (i = i.toString(16)) + (o = o.toString(16)))
								}, n = [e], i = 0; i <= 9; i++) n.push(t(e, Number((i / 10).toFixed(2))));
							return n.push(function(e, t) {
								var n = parseInt(e.slice(0, 2), 16),
									i = parseInt(e.slice(2, 4), 16),
									o = parseInt(e.slice(4, 6), 16);
								return n = Math.round((1 - t) * n), i = Math.round((1 - t) * i), o = Math.round((1 - t) * o), "#" + (n =
									n.toString(16)) + (i = i.toString(16)) + (o = o.toString(16))
							}(e, .1)), n
						}
					}
				},
				O = (n("BsIa"), Object(h.a)(D, function() {
					var e = this,
						t = e.$createElement;
			...
			var L = O.exports,
				I = {
					...
					computed: r()({}, Object(s.b)(["sidebar", "name", "avatar", "device"])),
					methods: {
				...
				B = (n("FJPP"), Object(h.a)(I, function() {
					var e = this,
						t = e.$createElement,
						i = e._self._c || t;
					return i("div", {
					...
					})], 1), e._v(" "), i("lang-select", {
						staticClass: "international right-menu-item"
					})] : e._e(), e._v(" "), i("el-dropdown", {
					...
					}, [i("el-dropdown-item", [e._v(e._s(e.$t("navbar.dashboard")))])], 1), e._v(" "), i(
						"el-dropdown-item", {
							attrs: {
								divided: ""
							}
						...
						}, [e._v(e._s(e.$t("navbar.logOut")))])])], 1)], 1)], 2)], 1)
				}, [], !1, null, "0f4dd8d3", null));
			...
			var A = B.exports,
				...
				$ = Object(h.a)(j, void 0, void 0, !1, null, null, null);
			$.options.__file = "Item.vue";
			var U = $.exports,
				G = {
					props: {
						to: {
				...
				N = Object(h.a)(G, function() {
					var e = this.$createElement;
					return (this._self._c || e)("component", this._b({}, "component", this.linkProps(this.to), !1), [this._t(
						"default")], 2)
				}, [], !1, null, null, null);
			N.options.__file = "Link.vue";
			var q = {
					name: "SidebarItem",
					components: {
						Item: U,
					...
					methods: {
						hasOneShowingChild: function(e, t) {
							...
							return 1 === i.length || 0 === i.length && (this.onlyOneChild = r()({}, t, {
								path: "",
								noShowingChildren: !0
							}), !0)
						},
						resolvePath: function(e) {
							return this.isExternalLink(e) ? e : R.a.resolve(this.basePath, e)
						},
						isExternalLink: function(e) {
							return Object(P.c)(e)
						},
				...
				F = Object(h.a)(q, function() {
					var e = this,
						t = e.$createElement,
						n = e._self._c || t;
					return !e.item.hidden && e.item.children ? n("div", {
						staticClass: "menu-wrapper"
					}, [!e.hasOneShowingChild(e.item.children, e.item) || e.onlyOneChild.children && !e.onlyOneChild.noShowingChildren ||
						e.item.alwaysShow ? n("el-submenu", {
							ref: "submenu",
							attrs: {
							...
							return t.hidden ? e._e() : [t.children && t.children.length > 0 ? n("sidebar-item", {
								key: t.path,
								...
								attrs: {
									icon: t.meta.icon,
									title: e.generateTitle(t.meta.title)
								}
							}) : e._e()], 1)], 1)]
						})], 2) : [n("app-link", {
							attrs: {
			...
			F.options.__file = "SidebarItem.vue";
			var J = {
					components: {
						SidebarItem: F.exports
					},
					computed: r()({}, Object(s.b)(["permission_routers", "sidebar"]), {
						isCollapse: function() {
							return !this.sidebar.opened
						}
					})
				},
				Z = Object(h.a)(J, function() {
					var e = this.$createElement,
						t = this._self._c || e;
					return t("el-scrollbar", {
						attrs: {
			...
			var W = Z.exports,
					...
					methods: {
						...
						moveToTarget: function(e) {
							var t = this.$refs.scrollContainer.$el.offsetWidth,
								...
								r = null,
								s = null;
							i.length > 0 && (o = i[0], a = i[i.length - 1]);
							for (var c = 0; c < i.length; c++)
								if (i[c] === e) {
									0 === c ? s = i[c].length > 1 && i[c + 1] : c === i.length - 1 ? r = i[c].length > 1 && i[c - 1] : (r = i[
										c - 1], s = i[c + 1]);
									break
								} if (o === e) n.scrollLeft = 0;
							else if (a === e) n.scrollLeft = n.scrollWidth - t;
							else {
								var l = s.$el.offsetLeft + s.$el.offsetWidth + 4,
									u = r.$el.offsetLeft - 4;
								l > n.scrollLeft + t ? n.scrollLeft = l - t : u < n.scrollLeft && (n.scrollLeft = u)
							}
						}
					}
				},
				X = (n("Cm1J"), Object(h.a)(K, function() {
					var e = this,
						t = e.$createElement;
					return (e._self._c || t)("el-scrollbar", {
						ref: "scrollContainer",
				...
				}, [], !1, null, "921dd1f6", null));
			X.options.__file = "index.vue";
			var ee = {
					components: {
						ScrollPane: X.exports
					},
					data: function() {
						return {
							visible: !1,
					...
					watch: {
						...
						visible: function(e) {
							e ? document.body.addEventListener("click", this.closeMenu) : document.body.removeEventListener("click",
								this.closeMenu)
						}
					},
					mounted: function() {
					...
					methods: {
						...
						addViewTags: function() {
							return this.$route.name && this.$store.dispatch("addView", this.$route), !1
						},
						moveToCurrentTag: function() {
							...
							this.$nextTick(function() {
								var n = !0,
									...
									o = void 0;
								try {
									for (var a, r = Q()(t); !(n = (a = r.next()).done); n = !0) {
										var s = a.value;
										if (s.to.path === e.$route.path) {
											e.$refs.scrollPane.moveToTarget(s), s.to.fullPath !== e.$route.fullPath && e.$store.dispatch(
												"updateVisitedView", e.$route);
											break
										}
									}
								} catch (e) {
						...
						closeSelectedTag: function(e) {
							...
							this.$store.dispatch("delView", e).then(function(n) {
								...
								if (t.isActive(e)) {
									var o = i.slice(-1)[0];
									o ? t.$router.push(o) : t.$router.push("/")
								}
							})
						},
						...
						openMenu: function(e, t) {
							var n = this.$el.getBoundingClientRect().left,
								...
								o = t.clientX - n + 15;
							this.left = o > i ? i : o, this.top = t.clientY, this.visible = !0, this.selectedTag = e
						},
						closeMenu: function() {
							this.visible = !1
						}
				...
				te = (n("viCB"), n("Yymj"), Object(h.a)(ee, function() {
					var e = this,
						t = e.$createElement,
						n = e._self._c || t;
					return n("div", {
						...
						return n("router-link", {
							...
							on: {
								click: function(n) {
									n.preventDefault(), n.stopPropagation(), e.closeSelectedTag(t)
								}
							}
						})])
					})), e._v(" "), n("ul", {
					...
					}, [e._v(e._s(e.$t("tagsView.refresh")))]), e._v(" "), n("li", {
						on: {
							click: function(t) {
								e.closeSelectedTag(e.selectedTag)
							}
						}
					}, [e._v(e._s(e.$t("tagsView.close")))]), e._v(" "), n("li", {
						on: {
							click: e.closeOthersTags
						}
					}, [e._v(e._s(e.$t("tagsView.closeOthers")))]), e._v(" "), n("li", {
						on: {
							click: e.closeAllTags
						}
					}, [e._v(e._s(e.$t("tagsView.closeAll")))])])], 1)
				}, [], !1, null, "293422f6", null));
			te.options.__file = "TagsView.vue";
			var ne = te.exports,
				ie = {
					name: "AppMain",
					computed: {
				...
				oe = (n("QF3o"), Object(h.a)(ie, function() {
					var e = this.$createElement,
						t = this._self._c || e;
					return t("section", {
				...
				}, [], !1, null, "8e4a32d6", null));
			oe.options.__file = "AppMain.vue";
			var ae = oe.exports,
				re = n("Q2AE"),
				se = document.body,
				ce = {
					...
					mixins: [{
						watch: {
							$route: function(e) {
								"mobile" === this.device && this.sidebar.opened && re.a.dispatch("closeSideBar", {
									withoutAnimation: !1
								})
							}
						},
						...
						mounted: function() {
							this.isMobile() && (re.a.dispatch("toggleDevice", "mobile"), re.a.dispatch("closeSideBar", {
								withoutAnimation: !0
							}))
						},
						methods: {
							isMobile: function() {
								return se.getBoundingClientRect().width - 3 < 1024
							},
							resizeHandler: function() {
								if (!document.hidden) {
									var e = this.isMobile();
									re.a.dispatch("toggleDevice", e ? "mobile" : "desktop"), e && re.a.dispatch("closeSideBar", {
										withoutAnimation: !0
									})
								}
							}
				...
				le = (n("4eCf"), Object(h.a)(ce, function() {
					var e = this,
						t = e.$createElement,
						n = e._self._c || t;
					return n("div", {
					...
					}, [n("navbar"), e._v(" "), n("tags-view"), e._v(" "), n("app-main")], 1)], 1)
				}, [], !1, null, "5994e6ac", null));
			le.options.__file = "Layout.vue";
			var ue = le.exports,
				de = {
					path: "/automation",
					component: ue,
					...
					children: [{
						...
						path: "testCase",
						component: function() {
							return Promise.all([n.e("chunk-079f"), n.e("chunk-38d7")]).then(n.bind(null, "UYda"))
						},
						meta: {
							icon: "edit",
							title: "Test Case",
						...
						path: "testModule",
						component: function() {
							return n.e("chunk-1d92").then(n.bind(null, "mZXu"))
						},
						meta: {
							icon: "edit",
							title: "Test Module",
						...
						path: "testObject",
						component: function() {
							return n.e("chunk-4cc7").then(n.bind(null, "4J0G"))
						},
						meta: {
							icon: "edit",
							title: "Test Object",
						...
						path: "testData",
						component: function() {
							return Promise.all([n.e("chunk-079f"), n.e("chunk-127d")]).then(n.bind(null, "vFMQ"))
						},
						meta: {
							icon: "edit",
							title: "Test Data",
						...
						path: "testSuite",
						component: function() {
							return Promise.all([n.e("chunk-6afd"), n.e("chunk-2490")]).then(n.bind(null, "EzLz"))
						},
						meta: {
							icon: "edit",
							title: "Test Suite",
				...
				he = {
					path: "/automationExcution",
					component: ue,
					redirect: "/automationExcution/report",
					name: "UI Automation Excution",
					meta: {
						title: "UI Execution",
						icon: "component"
					},
					children: [{
						...
						path: "execute",
						component: function() {
							return Promise.all([n.e("chunk-21b5"), n.e("chunk-1ce3")]).then(n.bind(null, "BkV+"))
						},
						meta: {
							icon: "edit",
							title: "Test Execute",
						...
						path: "report",
						component: function() {
							return Promise.all([n.e("chunk-079f"), n.e("chunk-cf81"), n.e("chunk-9baa")]).then(n.bind(null, "mHmS"))
						},
						meta: {
							icon: "clipboard",
							title: "Test Report",
				...
				pe = {
					...
					children: [{
						...
						path: "index",
						component: function() {
							return n.e("chunk-dff2").then(n.bind(null, "RGjw"))
						},
						meta: {
							icon: "user",
							title: "User Manage",
			...
			var me = [{
					...
					path: "/login",
					component: function() {
						return n.e("chunk-3e1d").then(n.bind(null, "ntYl"))
					},
					meta: {
						title: "Login Page"
					},
					...
					path: "/404",
					component: function() {
						return n.e("chunk-0bd4").then(n.bind(null, "/eX4"))
					},
					hidden: !0
				}, {
					path: "/401",
					component: function() {
						return n.e("chunk-1357").then(n.bind(null, "UUO+"))
					},
					hidden: !0
				}, {
					path: "/",
					component: ue,
					redirect: "/automationExcution/execute"
				}],
				fe = (t.c = new o.a({
					mode: "hash",
		...
		s67L: function(e, t, n) {
			e.exports = n.p + "static/img/user.6cc8069.jpg"
		},
		s7Vf: function(e, t, n) {
			"use strict";
			n.r(t);
		...
		t3Un: function(e, t, n) {
			...
			var i = n("Asgo"),
				...
				u = void 0,
				d = void 0;
			u = window.PROD.HOST, d = window.PROD.PORT;
			var h = r.a.create({
				baseURL: "http://" + u + ":" + d,
				timeout: 5e3
			});
			h.interceptors.request.use(function(e) {
				return c.a.getters.token && (e.headers["X-Token"] = Object(l.a)()), e
			}, function(e) {
				console.log(e), o.a.reject(e)
			}), h.interceptors.response.use(function(e) {
				return e
			}, function(e) {
				return console.log("err" + e), Object(s.Message)({
					message: e.message,
					type: "error",
					duration: 5e3
				}), o.a.reject(e)
