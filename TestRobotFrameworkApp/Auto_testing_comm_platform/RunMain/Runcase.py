...
Test_report_name = Test_report_path+"\\Selenium_Auto_test_Report.html"
# 搜索测试用例
suit = unittest.defaultTestLoader.discover(Test_case_path,pattern='QQ_mail.py')
#print(suit)
# 执行测试用例+写报告
...
mail.Add_file(Test_report_name,'Selenium_Auto_test_Report.html')
