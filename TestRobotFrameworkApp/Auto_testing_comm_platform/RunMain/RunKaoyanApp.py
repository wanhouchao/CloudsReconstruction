...
# 定义测试用例目录
Test_case_path =os.getcwd()[:-8]+'\\Testcase\\AppiumCaseDemo'#getcwd当前目录
# 定义测试报告目录
Test_report_path = os.getcwd()[:-8]+'\\Report'
Test_report_name = Test_report_path+"\\KaoyanApp_AutoReport.html"
# 搜索测试用例
suit = unittest.defaultTestLoader.discover(Test_case_path,pattern='kaoyanApp.py')
# 执行测试用例+写报告
...
mail.Add_file(Test_report_name,'KaoyanApp_AutoReport.html')
